...
import { useData, useTimer } from '../context/DataContext';
...
export const Tracking = () => {
  ...
  const {
    topics,
    addTopic, updateTopic, addManualMinutes, deleteTopic
  } = useData();

  const {
    activeTopicId, timerState, elapsedSeconds,
    selectTopic, startTimer, pauseTimer, stopTimer, resumeTimer
  } = useTimer();
